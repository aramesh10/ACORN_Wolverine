...
#ifndef AVX_FUNCTIONS
#define AVX_FUNCTIONS
...
namespace acornlib
{
    ...
    const labeltype INVALID_LABEL = SIZE_MAX;
    ...
    {
    public:
        virtual bool operator()(acornlib::labeltype id) { return true; }
    ...
    public:
        ...
        searchKnn(const void *, size_t, bool (*predicate)(const acornlib::labeltype)) const = 0;

        // Return k nearest neighbor in the order of closer fist
        virtual std::vector<std::pair<dist_t, labeltype>>
        searchKnnCloserFirst(const void *query_data, size_t k, bool (*predicate)(const acornlib::labeltype)) const;
                                                     ...
                                                     bool (*predicate)(const acornlib::labeltype)) const
    {
        ...
        auto ret = searchKnn(query_data, k, predicate);
        {
            size_t sz = ret.size();
            result.resize(sz);
            while (!ret.empty())
